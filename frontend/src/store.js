...
const slice = createSlice({name:'warrant',initialState:{current:null,history:[],status:'idle',error:null,estimate:null,estimateStatus:'idle',estimateError:null,stockScore:null,stockScoreStatus:'idle',stockScoreError:null},reducers:{},extraReducers:b=>b
  ...
  .addCase(scoreStock.pending,s=>{s.stockScoreStatus='loading';s.stockScoreError=null})
